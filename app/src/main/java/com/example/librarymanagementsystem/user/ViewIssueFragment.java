...
import com.example.librarymanagementsystem.admin.IssueBookAdapter;
 ...
 * Use the {@link ViewIssueFragment#newInstance} factory method to
...
public class ViewIssueFragment extends Fragment {
    ...
    DatabaseHandler db;
    com.example.librarymanagementsystem.admin.IssueBookAdapter IssueBookAdapter;
    List<DbModel> list;
     ...
     * @return A new instance of fragment ViewIssueFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ViewIssueFragment newInstance(String param1, String param2) {
        ViewIssueFragment fragment = new ViewIssueFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_view_issue, container, false);
        ...
        for (DbModel books:list) {
            if(books.getI_stud_id().equals(name)) {
